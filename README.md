...
- **[Fairness Metrics Computation:](https://github.com/MiltonGreat/Credit-Risk-Fairness-Analysis.git)** Used Aequitas and Fairlearn to calculate Demographic Parity, Equalized Odds, and Disparate Impact.
